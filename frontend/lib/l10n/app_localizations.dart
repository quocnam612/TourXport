...
abstract class AppLocalizations {
  ...
  /// Thanh điều hướng Đã lưu
  ///
  /// In vi, this message translates to:
  /// **'Đã lưu'**
  String get saved;

  /// Thanh điều hướng Cá nhân
  ///
  /// In vi, this message translates to:
  /// **'Cá nhân'**
  String get profile;
  ...
  /// Xem trước giao diện sau khi thay đổi
  ///
  /// In vi, this message translates to:
  /// **'Xem trước giao diện'**
  String get preview_interface;

  /// Cấu hình vùng và định dạng
  ///
  /// In vi, this message translates to:
  /// **'Vùng & Định dạng'**
  String get region_format;
  ...
  String get based_on_system;

  /// Thông báo cập nhật thành công
  ///
  /// In vi, this message translates to:
  /// **'Cập nhật ngôn ngữ thành công!'**
  String get language_updated_success;
