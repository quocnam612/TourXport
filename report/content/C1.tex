...
\quad TourXport là ứng dụng du lịch thông minh, giúp người dùng khám phá và tìm kiếm những địa điểm tham quan ở Việt Nam một cách cá nhân hóa. Dựa trên sở thích và điều kiện của từng người, ứng dụng gợi ý các điểm đến phù hợp, tích hợp bản đồ định vị và xây dựng lộ trình di chuyển tối ưu. Ứng dụng được xây dựng theo định hướng Flutter \cite{flutter_doc}, bám theo các chuẩn giao diện hiện đại của Material Design 3 \cite{material3} để đảm bảo tính nhất quán trên nhiều nền tảng.

\quad Điểm khác biệt của TourXport là kết hợp dữ liệu bản đồ, thời tiết và hướng dẫn di chuyển trong cùng một hệ thống, mang lại trải nghiệm du lịch trọn vẹn và thuận tiện hơn. Phần giao diện được triển khai bằng Dart \cite{dart_guide} với phong cách thiết kế trực quan, trong đó các hiệu ứng trong suốt lấy cảm hứng từ glassmorphism \cite{glassmorphism} được dùng cho một số màn hình chính.
